...
def main(args):
    ...
    api = alpaca.REST(base_url=base_url,key_id=api_key_id,secret_key=api_secret,api_version='v2')
    stream = alpaca.StreamConn(base_url=base_url,key_id=api_key_id,secret_key=api_secret)
